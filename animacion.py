...
if __name__ == "__main__":
    ...
    # Cantidad_boxes entre 1 y 10 y los fps entre 300 y 1000. Si no ingresa uno valido le vuelve a pedir
    ...
    # Simular en un thread separado para evitar bloquear pygame
    import threading
